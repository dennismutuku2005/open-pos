                ...
                <div className="flex gap-2 sm:gap-3">
                    {otp.map((digit, index) => (
                        <input
                            ...
                            onPaste={handlePaste}
                            className="w-10 h-12 sm:w-12 sm:h-14 text-center text-lg font-bold bg-card-bg border border-openpos-border text-openpos-purple rounded-xl focus:border-openpos-purple focus:ring-1 focus:ring-openpos-purple outline-none transition-all uppercase tracking-tighter"
                        />
                    ))}
                </div>
                ...
                <div className="flex flex-col items-center gap-2">
                    <button 
                        ...
                        className={cn(
                            ...
                            timer > 0 ? "text-admin-dim cursor-not-allowed" : "text-openpos-purple hover:text-openpos-purple/80"
                        )}
                    >
