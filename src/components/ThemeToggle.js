    ...
    return (
        <button
            ...
            className="relative flex items-center justify-center w-9 h-9 rounded-xl 
                 bg-openpos-bg-subtle border border-openpos-border 
                 hover:bg-openpos-purple-light hover:border-openpos-purple/30 
        ...
        >
            <AnimatePresence mode="wait" initial={false}>
                {theme === "dark" ? (
                    ...
                    >
                        <Moon className="w-4.5 h-4.5 text-openpos-purple" />
                    </motion.div>
                ) : (
                    <motion.div
                        key="sun"
                        ...
                        transition={{ duration: 0.2, ease: "easeOut" }}
                    >
                        <Sun className="w-4.5 h-4.5 text-openpos-purple" />
                    </motion.div>
                )}
            </AnimatePresence>
