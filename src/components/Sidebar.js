...
export function Sidebar({ isSidebarOpen, setIsSidebarOpen, isMobile, pathname, isZenMode, setIsZenMode }) {
    ...
    const navigation = [
        ...
        
        {
            ...
            icon: BarChart3,
            children: [
                { name: 'Sales Analysis', href: '/dashboard/report', badge: 'Hot' },
                { name: 'Profit & Loss', href: '/dashboard/profit-loss' },
                                    ...
                                    <div className="sopenpos-y-0.5">
                                        <button
                                            ...
                                            className={cn(
                                                ...
                                                isActive && !isExpanded ? "bg-openpos-blue/10 text-openpos-blue font-semibold" : "text-admin-label hover:bg-openpos-bg-subtle hover:text-foreground"
                                            )}
                                        >
                                            <item.icon size={18} className={cn("shrink-0 transition-colors", isActive ? "text-openpos-blue" : "text-admin-dim group-hover:text-admin-label")} />
                                            {showText && (
                                                        ...
                                                        <Link
                                                            ...
                                                            className={cn(
                                                                ...
                                                                isChildActive
                                                                    ...
                                                                    : "text-admin-dim hover:text-foreground hover:bg-openpos-bg-subtle"
                                                            )}
                                                        >
                                    ...
                                    <Link
                                        ...
                                        className={cn(
                                            ...
                                            isActive
                                                ...
                                                : "text-admin-label hover:bg-openpos-bg-subtle hover:text-foreground"
                                        )}
                                    >
