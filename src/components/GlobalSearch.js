        ...
        <div className="relative group" ref={wrapperRef}>
            <div className="flex items-center">
                ...
                <input
                    ...
                    className="pl-9 pr-12 py-2 w-full bg-openpos-bg-subtle border-openpos-border border focus:bg-card-bg focus:border-openpos-blue/30 rounded-xl text-[11px] outline-none transition-all placeholder:text-admin-dim font-bold text-admin-value lg:w-[400px] shadow-sm"
                />
                        ...
                        {results.map((item, idx) => (
                            <button
                                ...
                                className={cn(
                                    ...
                                    idx === activeIndex ? "bg-openpos-blue/5 text-openpos-blue" : "text-admin-label hover:bg-openpos-bg-subtle"
                                )}
                            >
