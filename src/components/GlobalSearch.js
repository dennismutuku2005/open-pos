        ...
        <div className="relative group" ref={wrapperRef}>
            <div className="flex items-center">
                <Search className={cn(
                    ...
                    query ? "text-openpos-purple" : "text-gray-400"
                )} size={12} />
                <input
                    ref={inputRef}
                    type="text"
                    ...
                    className="pl-9 pr-12 py-1.5 w-64 bg-openpos-bg-subtle border-openpos-border border focus:bg-card-bg focus:border-openpos-purple/30 rounded-xl text-[11px] outline-none transition-all placeholder:text-admin-dim font-medium text-foreground lg:w-80"
                />
            ...
            {isOpen && (
                <div className="absolute top-full mt-2 left-0 right-0 bg-card-bg border border-openpos-border rounded-xl shadow-2xl overflow-hidden z-[60] animate-in fade-in slide-in-from-top-2 duration-200">
                        ...
                        {results.map((item, idx) => (
                            <button
                                ...
                                className={cn(
                                    ...
                                    idx === activeIndex ? "bg-openpos-purple/10 text-openpos-purple" : "text-admin-label hover:bg-openpos-bg-subtle"
                                )}
                            >
                                <div className="flex items-center gap-3">
                                    <div className={cn(
                                        "w-7 h-7 rounded-lg flex items-center justify-center transition-all",
                                        idx === activeIndex ? "bg-openpos-purple text-white shadow-sm shadow-openpos-purple/20 scale-105" : "bg-openpos-bg-subtle text-admin-dim"
                                    )}>
                                        <item.icon size={14} />
                                    </div>
                    ...
                    <div className="px-3 py-2 bg-openpos-bg-subtle border-t border-openpos-border flex items-center justify-between">
