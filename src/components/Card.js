...
export function StatCard({ 
    ...
    return (
        <div className={cn(
            "bg-card-bg border border-openpos-border rounded-2xl p-4 shadow-sm hover:border-openpos-blue/30 transition-all group overflow-hidden relative",
            className
        )}>
            <div className="flex items-center gap-3">
                <div className={cn(
                    "w-10 h-10 rounded-xl flex items-center justify-center shrink-0 border transition-all group-hover:scale-105", 
