...
"July","August","September","October","November","December"
 ...
 <button onClick={prevMonth} className="p-1.5 rounded-lg text-admin-dim transition-colors">
 <ChevronLeft size={16} />
 </button>
 <button onClick={nextMonth} className="p-1.5 rounded-lg text-admin-dim transition-colors">
...
"h-8 flex items-center justify-center text-[11px] font-bold cursor-pointer rounded-lg transition-all relative z-10",
 !isSelected(d) && !mid &&"text-admin-value",
