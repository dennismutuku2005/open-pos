        ...
        <div className="p-4 bg-card-bg select-none font-figtree">
            <div className="flex items-center justify-between mb-4">
                ...
                <div className="flex gap-1">
                    <button onClick={prevMonth} className="p-1.5 hover:bg-openpos-bg-subtle rounded-lg text-admin-dim hover:text-admin-value transition-colors">
                        <ChevronLeft size={16} />
                    </button>
                    <button onClick={nextMonth} className="p-1.5 hover:bg-openpos-bg-subtle rounded-lg text-admin-dim hover:text-admin-value transition-colors">
                    ...
                    return (
                        <div
                            ...
                            className={cn(
                                ...
                                !isSelected(d) && !mid && "hover:bg-openpos-bg-subtle text-admin-value",
                                isSelected(d) && "bg-openpos-purple text-white shadow-md shadow-openpos-purple/20",
                                mid && !start && !end && "bg-openpos-purple/5 text-openpos-purple rounded-none",
                                start && "bg-openpos-purple text-white rounded-r-none rounded-l-lg",
                                end && "bg-openpos-purple text-white rounded-l-none rounded-r-lg",
                                range && mid && "z-20"
                            )}
                        >
                            {d}
