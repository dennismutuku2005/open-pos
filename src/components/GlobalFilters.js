            ...
            {showRouterFilter && (
                <div className="relative w-full sm:w-auto">
                    <button
                        ...
                        className="flex items-center justify-between gap-3 px-4 py-2.5 bg-card-bg border border-openpos-border rounded-xl hover:border-openpos-purple/30 transition-all w-full sm:w-48 text-left group"
                    >
                        <div className="flex items-center gap-2 overflow-hidden">
                            <Router size={16} className="text-admin-dim group-hover:text-openpos-purple transition-colors shrink-0" />
                            ...
                            <div className="absolute top-full left-0 mt-2 w-full sm:w-56 bg-card-bg border border-openpos-border rounded-xl shadow-2xl z-50 py-2 animate-in fade-in zoom-in duration-200 max-h-[300px] overflow-y-auto transition-colors duration-300">
                                {routers.map((router) => (
                                    <button
                                        ...
                                        className="flex items-center justify-between w-full px-4 py-2 text-xs font-bold hover:bg-openpos-bg-subtle transition-colors text-admin-value"
                                    >
                                        {router}
                                        {selectedRouter === router && <Check size={14} className="text-openpos-purple" />}
                                    </button>
                                ))}
                            </div>
                        </>
            ...
            {showDateFilter && (
                <div className="relative w-full sm:w-auto">
                    <button
                        ...
                        className="flex items-center justify-between gap-3 px-4 py-2.5 bg-card-bg border border-openpos-border rounded-xl hover:border-openpos-purple/30 transition-all w-full sm:w-52 text-left group"
                    >
                        <div className="flex items-center gap-2 overflow-hidden">
                            <CalendarIcon size={16} className="text-admin-dim group-hover:text-openpos-purple transition-colors shrink-0" />
                            ...
                            <div className="absolute top-full right-0 mt-2 w-full sm:w-72 bg-card-bg border border-openpos-border rounded-xl shadow-2xl z-50 overflow-hidden animate-in fade-in zoom-in duration-200 transition-colors duration-300">
                                {dateView === 'presets' ? (
                                    <div className="py-2">
                                        ...
                                        {dateRanges.map((range) => (
                                            <button
                                                ...
                                                className="flex items-center justify-between w-full px-4 py-2.5 text-xs font-bold hover:bg-openpos-bg-subtle transition-colors text-admin-value"
                                            >
                                                <div className="flex items-center gap-2">
                                                    <Clock size={14} className={cn("text-admin-dim", selectedDateRange === range && "text-openpos-purple")} />
                                                    {range}
                                                </div>
                                                {selectedDateRange === range && <Check size={14} className="text-openpos-purple" />}
                                            </button>
                                        ))}

                                        <div className="px-2 mt-2 pt-2 border-t border-openpos-border flex flex-col gap-1">
                                            <button
                                                onClick={() => setDateView('single')}
                                                className="w-full py-2 bg-openpos-bg-subtle hover:bg-openpos-purple/10 text-openpos-purple rounded-lg text-[10px] font-bold uppercase tracking-widest transition-colors"
                                            >
                                    ...
                                    <div className="animate-in slide-in-from-right duration-300">
                                        <div className="px-4 py-3 border-b border-openpos-border flex items-center justify-between bg-openpos-bg-subtle">
                                            <button
                                                onClick={() => setDateView('presets')}
                                                className="p-1 hover:bg-openpos-bg-subtle rounded-md text-admin-dim hover:text-admin-value transition-all border border-transparent hover:border-openpos-border"
                                            >
                                                <ArrowLeft size={16} />
                                            </button>
                                        ...
                                        />
                                        <div className="p-3 border-t border-openpos-border bg-openpos-bg-subtle">
                                        ...
                                        <div className="px-4 py-3 border-b border-openpos-border flex items-center justify-between bg-openpos-bg-subtle">
                                            ...
                                            <div className="flex items-center gap-2">
                                                <button
                                                    ...
                                                    className="p-1 hover:bg-openpos-bg-subtle rounded-lg text-admin-dim hover:text-admin-value"
                                                >
                                                ...
                                                return (
                                                    <button
                                                        ...
                                                        className={cn(
                                                            ...
                                                            isSelected
                                                                ? "bg-openpos-purple text-white border-openpos-purple shadow-sm"
                                                                : "bg-card-bg text-admin-value border-openpos-border hover:border-openpos-purple/30 hover:bg-openpos-purple/5 hover:text-openpos-purple"
                                                        )}
                                                    >
                                                        {month}
                                                    </button>
