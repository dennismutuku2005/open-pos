...
export function GlobalFilters({ onFilterChange, defaultDateRange ='Today', showDateFilter = true, showRouterFilter = true }) {
 ...
 className="flex items-center justify-between w-full px-4 py-2 text-xs font-bold transition-colors text-admin-value"
 >
 {router}
 ...
 className="flex items-center justify-between w-full px-4 py-2.5 text-xs font-bold transition-colors text-admin-value"
 >
 ...
 className="w-full py-2 bg-openpos-bg-subtle text-openpos-purple rounded-lg text-[10px] font-bold uppercase tracking-widest transition-colors"
 >
 ...
 className="p-1 rounded-md text-admin-dim transition-all border border-transparent"
 >
 <ArrowLeft size={16} />
 </button>
 ...
 className="p-1 rounded-lg text-admin-dim"
 >
...
"py-2.5 rounded-lg text-xs font-bold transition-all border",
 ...
 :"bg-card-bg text-admin-value border-openpos-border"
 )}
 >
 {month}
 </button>
