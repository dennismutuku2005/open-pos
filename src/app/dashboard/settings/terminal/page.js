                ...
                <div className="lg:col-span-2 space-y-6">
                    ...
                    >
                        <div className="space-y-4 mt-4">
                            <div className="flex items-center justify-between p-4 bg-openpos-bg-subtle border border-openpos-border rounded-2xl group hover:border-openpos-blue/30 transition-all">
