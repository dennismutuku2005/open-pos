        ...
        <div className="space-y-6 animate-in fade-in duration-500 font-figtree pb-10">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                ...
                <div className="flex gap-3 w-full sm:w-auto">
                    <button className="flex-1 sm:flex-none bg-card-bg border border-openpos-border text-admin-value px-4 py-2.5 rounded-xl font-bold text-[11px] flex items-center justify-center gap-2 hover:bg-openpos-bg-subtle transition-all uppercase tracking-widest shadow-sm">
                        <Calendar size={16} />
                        As of Today
                    </button>
                    <button 
                            ...
                            <div>
                                ...
                                <div className="space-y-8">
                                    <div>
                                        ...
                                        <div className="space-y-4">
                                            <div className="flex justify-between items-center group">
                                                <span className="text-[12px] font-bold text-admin-dim uppercase tracking-tight group-hover:text-admin-value transition-colors">Cash & Equivalents</span>
                                                <span className="text-[13px] font-bold text-admin-value tabular-nums">125,500.00</span>
                                            </div>
                                            <div className="flex justify-between items-center group">
                                                <span className="text-[12px] font-bold text-admin-dim uppercase tracking-tight group-hover:text-admin-value transition-colors">Accounts Receivable</span>
                                                <span className="text-[13px] font-bold text-admin-value tabular-nums">145,000.00</span>
                                            </div>
                                            <div className="flex justify-between items-center group">
                                                <span className="text-[12px] font-bold text-admin-dim uppercase tracking-tight group-hover:text-admin-value transition-colors">Inventory Liquidity</span>
                                    ...
                                    <div>
                                        ...
                                        <div className="space-y-4">
                                            <div className="flex justify-between items-center group">
                                                <span className="text-[12px] font-bold text-admin-dim uppercase tracking-tight group-hover:text-admin-value transition-colors">Operational Equipment</span>
                                                <span className="text-[13px] font-bold text-admin-value tabular-nums">250,000.00</span>
                                            </div>
                                            <div className="flex justify-between items-center group">
                                                <span className="text-[12px] font-bold text-admin-dim uppercase tracking-tight group-hover:text-admin-value transition-colors">Furniture & Infrastructure</span>
                            ...
                            <div>
                                ...
                                <div className="space-y-8">
                                    <div>
                                        ...
                                        <div className="space-y-4">
                                            <div className="flex justify-between items-center group">
                                                <span className="text-[12px] font-bold text-admin-dim uppercase tracking-tight group-hover:text-admin-value transition-colors">Accounts Payable</span>
                                                <span className="text-[13px] font-bold text-admin-value tabular-nums">42,500.00</span>
                                            </div>
                                            <div className="flex justify-between items-center group">
                                                <span className="text-[12px] font-bold text-admin-dim uppercase tracking-tight group-hover:text-admin-value transition-colors">Short-term Debt</span>
                                                <span className="text-[13px] font-bold text-admin-value tabular-nums">150,000.00</span>
                                            </div>
                                            <div className="flex justify-between items-center group">
                                                <span className="text-[12px] font-bold text-admin-dim uppercase tracking-tight group-hover:text-admin-value transition-colors">Tax Liabilities</span>
                                    ...
                                    <div>
                                        ...
                                        <div className="space-y-4">
                                            <div className="flex justify-between items-center group">
                                                <span className="text-[12px] font-bold text-admin-dim uppercase tracking-tight group-hover:text-admin-value transition-colors">Owner's Capital</span>
                                                <span className="text-[13px] font-bold text-admin-value tabular-nums">500,000.00</span>
                                            </div>
                                            <div className="flex justify-between items-center group">
                                                <span className="text-[12px] font-bold text-admin-dim uppercase tracking-tight group-hover:text-admin-value transition-colors">Retained Earnings</span>
