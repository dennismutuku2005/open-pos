        ...
        <div className="space-y-6 animate-in fade-in duration-500 pb-10">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-3 w-full sm:w-auto">
                    ...
                    <button 
                        onClick={handleAdd}
                        className="flex-1 sm:flex-none bg-openpos-blue text-white px-5 py-2.5 rounded-xl font-bold text-[13px] flex items-center justify-center gap-2 shadow-lg shadow-openpos-blue/20 hover:scale-[1.02] transition-all uppercase tracking-widest"
                    >
                        <Plus size={18} />
                        Log Expense
                    </button>
            ...
            <Card 
                ...
                headerAction={
                    <div className="flex items-center gap-2">
                        <button className="p-2 bg-openpos-bg-subtle border border-openpos-border text-admin-dim rounded-xl hover:text-openpos-blue transition-all"><Printer size={14} /></button>
                        <button className="p-2 bg-openpos-bg-subtle border border-openpos-border text-admin-dim rounded-xl hover:text-openpos-blue transition-all"><Filter size={14} /></button>
                    </div>
                }
            >
                <div className="overflow-x-auto">
                    <table className="w-full text-left">
                        ...
                        <tbody className="divide-y divide-openpos-border">
                            {expenses.map((exp) => (
                                <tr key={exp.id} className="group hover:bg-openpos-bg-subtle/40 transition-colors cursor-default">
                                    <td className="p-5">
                ...
                <div className="space-y-5">
                    ...
                    <div className="space-y-1.5">
                        ...
                        <div className="relative">
                            ...
                            <input 
                                type="number"
                                className="w-full bg-openpos-bg-subtle border border-openpos-border rounded-xl pl-12 pr-4 py-3 text-[12px] font-bold outline-none focus:ring-2 focus:ring-openpos-blue/10 transition-all"
                                placeholder="0.00"
