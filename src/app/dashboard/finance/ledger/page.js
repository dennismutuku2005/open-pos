                ...
                <div className="flex bg-openpos-bg-subtle p-1 rounded-2xl ring-1 ring-openpos-border shadow-sm">
                    <button 
                        ...
                        className={cn(
                            ...
                            activeTab === 'customers' ? "bg-card-bg text-openpos-blue shadow-lg border border-openpos-border" : "text-admin-dim hover:text-admin-value"
                        )}
                    >
                        Customer Ledger
                    </button>
                    <button 
                        ...
                        className={cn(
                            "px-6 py-2 rounded-xl font-bold text-[10px] uppercase tracking-widest transition-all",
                            activeTab === 'suppliers' ? "bg-card-bg text-openpos-blue shadow-lg border border-openpos-border" : "text-admin-dim hover:text-admin-value"
                        )}
                    >
                        Vendor Ledger
                    </button>
            ...
            <Card 
                ...
                headerAction={
                    <div className="flex items-center gap-3">
                        ...
                        <button className="flex items-center gap-2 px-3 py-1.5 bg-openpos-bg-subtle border border-openpos-border rounded-lg text-admin-dim hover:text-openpos-blue hover:border-openpos-blue/30 transition-all">
                            <Filter size={14} />
                ...
                <div className="overflow-x-auto custom-scrollbar">
                    <table className="w-full text-left whitespace-nowrap border-collapse text-[11px]">
                        ...
                        <tbody className="divide-y divide-openpos-border">
                            {mockLedger.map(trx => (
                                <tr key={trx.id} className="group hover:bg-openpos-bg-subtle/40 transition-colors cursor-default">
                                    ...
                                    <td className="px-6 py-4">
                                        <span className="font-bold text-admin-value uppercase tracking-tight group-hover:text-openpos-blue transition-colors">{trx.id}</span>
                                    </td>
                                    <td className="px-6 py-4">
