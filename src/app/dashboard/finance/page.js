        ...
        <div className="space-y-8 animate-in fade-in duration-500 font-figtree pb-20">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                {financeModules.map((module) => (
                    ...
                    >
                        {/* "Item" Image Area */}
                        <div className="aspect-square rounded-[18px] bg-openpos-bg-subtle flex items-center justify-center relative overflow-hidden group-hover:scale-[1.02] transition-transform duration-500">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-2 bg-openpos-blue/5 border border-openpos-blue/10 rounded-[32px] p-8 flex flex-col md:flex-row items-center gap-8">
                    ...
                    <div className="w-48 h-48 bg-card-bg border border-openpos-border rounded-3xl shadow-2xl flex items-center justify-center p-6 rotate-3 hover:rotate-0 transition-transform duration-500">
